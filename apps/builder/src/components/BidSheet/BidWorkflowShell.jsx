 ...
 *
 * Tab order:
 *   1. Materials    — SOWMaterialTracker (breakout + cost codes)
 *   2. Labor        — field labor tasks + auto-calculated padding
 *   3. Glass        — per-lite pricing with surcharge + breakage
 *   4. Misc Labor   — daily cleaning, hardware, shop labor
 *   5. Summary      — BidSummaryDashboard with export
 *
