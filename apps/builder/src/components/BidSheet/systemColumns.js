...
export const SYSTEM_COLUMNS = {
  'ext-sf-1': [
    ...
    { key: 'gtBays', label: '> Bays', editable: true, type: 'number', width: '90px', tooltip: 'Number of bays above first floor (high-work labor input)', group: 'geometry' },
    { key: 'gtDlos', label: '> DLOs', editable: true, type: 'number', width: '90px', tooltip: 'Number of DLOs above first floor (high-work labor input)', group: 'geometry' },
